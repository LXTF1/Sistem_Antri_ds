...
function updateDateTime() {
    ...
    // Update DOM
    document.getElementById('urut-current-time').textContent = timeString;
    document.getElementById('urut-current-date').textContent = dateString;
}
...
function printTicket() {
    ...
    const instansiNama = document.getElementById('urut-instansi-nama').textContent;
